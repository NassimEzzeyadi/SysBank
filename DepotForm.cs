...
namespace Systeme_bancaire
{
    public partial class DepotForm: Form
    {
        ...
        private void btnValider_Click(object sender, EventArgs e)
        {
            ...
            // ✅ Effectuer le dépôt en base de données
            int transactionId = SQLDataAccess.DeposerArgent(compteId, montant);

            MessageBox.Show("Dépôt effectué avec succès !", "Succès", MessageBoxButtons.OK, MessageBoxIcon.Information);
